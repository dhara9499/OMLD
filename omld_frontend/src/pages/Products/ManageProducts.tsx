                    ...
                    <table className="w-full table-auto border border-gray-300">
                        <thead>
                            <tr className="bg-gray-2 text-left dark:bg-meta-4">
                                <th className="border border-gray-300 min-w-[120px] py-4 px-4 font-medium text-black dark:text-white">
                                    SKU
                                </th>
                                <th className="border border-gray-300 min-w-[220px] py-4 px-4 font-medium text-black dark:text-white xl:pl-11">
                                    Name
                                </th>
                                <th className="border border-gray-300 min-w-[120px] py-4 px-4 font-medium text-black dark:text-white">
                                    Qty
                                </th>
                                <th className="border border-gray-300 min-w-[150px] py-4 px-4 font-medium text-black dark:text-white">
                                    Price
                                </th>
                                <th className="border border-gray-300 py-4 px-4 font-medium text-black dark:text-white"></th>
                            </tr>
                        </thead>
                        <tbody>
                            {products &&
                                ...
                                products.map((product) => (
                                    <tr className="text-left border border-gray-300">
                                        <td className="border border-gray-300 min-w-[220px] py-4 px-4 font-medium text-black dark:text-white xl:pl-11">
                                            {product.sku}
                                        </td>
                                        <td className="border border-gray-300 min-w-[220px] py-4 px-4 font-medium text-black dark:text-white xl:pl-11">
                                            {product.name
...
function setAttributes(data: any) {
